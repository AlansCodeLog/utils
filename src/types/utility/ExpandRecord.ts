 ...
 *
 * ```ts
 * let obj = new Entries([{ key:"a" }, { key:"b" }])
 ...
 *
 * ```ts
 * let entries = (obj.entries as ExpandRecord<typeof obj.entries, "c" | "d" | "e")
 *
 * entries.c // no error
 * entries.d // no error
 * entries.e // no error
 ...
 * let entries =  (obj.entries as ExpandRecord<typeof obj.entries>)
 *
